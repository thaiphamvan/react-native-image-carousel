      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              ImageCarousel.__proto__ ||
              Object.getPrototypeOf(ImageCarousel)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
          _this)),
        (_this.openAnim = new reactNative.Animated.Value(0)),
        (_this.pan = new reactNative.Animated.Value(0)),
        (_this.carouselItems = Array.isArray(_this.props.children)
          ? _this.props.children.map(function() {
              return null;
            })
          : [null]),
        (_this.state = {
        ...
        (_this.close = function() {
          var activeComponent = _this.getComponentAtIdx(
        ...
        (_this.getComponentAtIdx = function(idx) {
          ...
          return activeComponents
            ? activeComponents[idx]
            : _this.carouselItems[idx];
        }),
        (_this.animateOpenAnimToValue = function(toValue, onComplete) {
          return reactNative.Animated.timing(
            _this.openAnim,
            Object.assign({}, ANIM_CONFIG, {
              toValue: toValue
            })
          ).start(function() {
        ...
        (_this.renderFullscreenContent = function(child, idx) {
          ...
          var containerStyle = [
            _this.getSwipeableStyle(idx),
            selectedIdx === idx && panning && { top: _this.pan }
          ];
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                _this.props.customTextClose || "Close"
              )
            )
          );
        }),
        ...
        (_this.renderFullscreen = function() {
          ...
          return React.createElement(
            ...
            React.createElement(reactNative.Animated.View, {
              style: [styles.modalBackground, opacity]
            }),
            React.createElement(
              SwipeableViews,
              {
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props = this.props,
          ...
          horizontal =
            _props$horizontal === undefined ? true : _props$horizontal,
